defmodule Solicit.Plugs.Validation.PaginationParamTest do
  use ExUnit.Case, async: true

  import Phoenix.ConnTest
  alias Solicit.Plugs.Validation.PaginationParam

  describe "call" do
    test "offset and page provided, expect error" do
      build_conn(:get, "?offset=1&page=1")
      |> Plug.Conn.fetch_query_params()
      |> PaginationParam.call(%{})
    ...
    test "offset provided" do
      ...
      assert conn == PaginationParam.call(conn, %{})
    end
