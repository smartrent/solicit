defmodule Solicit.Plugs.StripEmptyQueryParamsTest do
  use ExUnit.Case, async: true

  import Phoenix.ConnTest
  alias Solicit.Plugs.StripEmptyQueryParams

  doctest Solicit.Plugs.StripEmptyQueryParams
  ...
  describe "call" do
    ...
    test "query param not empty" do
      ...
      assert conn == StripEmptyQueryParams.call(conn, %{})
    end
    ...
    test "no query params" do
      ...
      %{params: %{}, query_params: %{}} = StripEmptyQueryParams.call(conn, %{})
    end
  end
end
